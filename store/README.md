...
4. The publisher chose to keep unpaid Gemini projects supported. The privacy page now states the developer's factual data-use commitment. Compatibility of the supported unpaid data handling with Chrome's Limited Use policy remains unresolved; obtain a clear basis before making the full certification. No official ruling on this app was found.
